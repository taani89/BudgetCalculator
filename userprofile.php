...
<!--<![endif]-->
	<head>
		<title>College Budget Plan</title>
        ...
        <!-- /About us -->
				...
				<div class="container services-sec">
					<div class="title-page">
					    ...
					    <p class="sub-header">A little about what you can do</p>
					</div>
						...
						<div class="row">
							<div class="col-md-4">
								<div class="service">
									...
									<a href="calculator.php"><h2 class="service-head">Budget Calculator</h2></a>
									<p>Calculates your every semester expenses now and start saving</p>
								</div>
							</div>
							...
							<div class="col-md-4">
								<div class="service">
									...
									<a href="viewProfile.php"><h2 class="service-head">Profile</h2></a>
									<p>Update and view your profile information.Information are now at your fingertips</p>
								</div>
							</div>
						</div>
					</section>
